...
class RuntimeEventType(StrEnum):
    ...
    ZERODHA_READ_ONLY_PROFILE_SMOKE_PASSED = "ZerodhaReadOnlyProfileSmokePassed"
    ZERODHA_READ_ONLY_PROFILE_SMOKE_FAILED = "ZerodhaReadOnlyProfileSmokeFailed"
    ZERODHA_INTEGRATION_AUDIT_COMPLETED = "ZerodhaIntegrationAuditCompleted"
